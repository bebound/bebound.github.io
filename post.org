...
After doing some research, I found [[https://github.com/Homebrew/homebrew-cask/pull/72284][Java has been moved to homebrew/core]]. As I installed java by cask, now it's not available and throw this error. Now I need to uninstall it from cask.

Finally I found this issue: [[https://github.com/Homebrew/homebrew-cask/issues/72562][brew cask upgrade fails with "No Cask with this name exists"]]. After running =rm -rf "$(brew --prefix)/Caskroom/java=, the error disappears.

*** DONE Improve Kafka throughput
...
The details can be found [[https://kafka.apache.org/documentation/#messageformat][here]].
