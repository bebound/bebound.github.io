...
{{< figure src="/images/transformer_add_pe.png" class="image-size-m" >}}
...
{{< figure src="/images/transformer_pe1.png" class="image-size-m" >}}
...
{{< figure src="/images/transformer_pe2.png" class="image-size-m" >}}
...
{{< figure src="/images/transformer_self_attention.png" class="image-size-m" >}}
...
{{< figure src="/images/transformer_multihead.png" class="image-size-m" >}}

Multi-head attention allows the model to jointly attend to information from different representation subspaces at different positions.

The whole procedure looks like this:

{{< figure src="/images/transformer_multihead_all.png" class="image-size-m" >}}
...
{{< figure src="/images/transformer_layer_norm.png" class="image-size-m" >}}
...
{{< figure src="/images/transformer_encoder.png" class="image-size-m" >}}
...
{{< figure src="/images/transformer_translate.gif" class="image-size-m" >}}
...
> Author: KK  
> URL: https://fromkk.com/posts/the-annotated-the-annotated-transformer/  
