...
The doc also does not eplain why `/opt/homebrew/lib/python3.12/site-packages` is in the path. I believe the doc is out-of-date: https://discuss.python.org/t/the-document-on-pythonhome-might-be-wrong/19614
