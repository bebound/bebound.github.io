...
*** How to disable auto strip in Charfield in Django               :Django:
   :PROPERTIES:
...
Later, =RedHatDude='s answer in [[https://discussions.apple.com/thread/252924363?login=true][this post]] gives me a clue, it looks like a iCloud sync problem. I trie to delete the account on my 3 MacBooks together. Thank goodness! It does not show up again.
