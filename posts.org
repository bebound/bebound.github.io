...
#+end_src
~setuptools~, there are some other build back-end such as ~hatchling~ and ~flit~. You can find the example here: [[https://packaging.python.org/en/latest/tutorials/packaging-projects/#choosing-a-build-backend][Python Packaging Uer Guide - Choosing a build backend]]
